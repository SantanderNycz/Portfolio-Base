  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-balance">42 School Projects</h1>
          <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
            Interactive demonstrations of C programming projects from 42 school. Each demo showcases the core
            functionality in an accessible web interface.
          </p>
        </div>
